export default function AboutPage() {
  return (
    <>
      ...
      <p>
        Over the last five years, my primary focus has been raising my daughter.
        Now that she is starting school, I am eager to re-enter the workforce.
        Two years ago, I embarked on my UX journey and gained valuable insights.
        I dedicated a year to mastering HTML, CSS, and React. Upon returning to
        UX design, I saw how important understanding front-end development was.
        This knowledge of element and layout limitations has greatly influenced
        my design process. Combining both skill sets, I successfully built my
        portfolio site – the one you are currently exploring!
      </p>
      <p>
